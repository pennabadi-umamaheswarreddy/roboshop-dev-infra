...
resource "aws_iam_instance_profile" "mysql1"{
  name = "mysql"
...
resource "aws_route53_record" "mongodb" {
  zone_id = var.zone_id
  name    = "mongodb-${var.environment}.${var.domain_name}" # mongodb-dev.umamaheswarreddy.fun
  type    = "A"
  ttl     = 1
...
resource "aws_route53_record" "redis" {
  zone_id = var.zone_id
  name    = "redis-${var.environment}.${var.domain_name}" # redis-dev.umamaheswarreddy.fun
  type    = "A"
  ttl     = 1
...
resource "aws_route53_record" "rabbitmq" {
  zone_id = var.zone_id
  name    = "rabbitmq-${var.environment}.${var.domain_name}" # rabbitmq-dev.umamaheswarreddy.fun
  type    = "A"
  ttl     = 1
